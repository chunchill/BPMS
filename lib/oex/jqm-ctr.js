...
ko.bindingHandlers.dynamicUIControl = {
   ...
   init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
      ...
      $($(element).children("label")[0]).attr("for", valueUnwrapped.option.name);
      $($(element).children("label")[0]).html(valueUnwrapped.option.name);
      var tag;
...
ko.bindingHandlers.responsiveTable = {
